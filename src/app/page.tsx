      ...
      <header className="fixed top-0 left-0 right-0 z-50 bg-purple-900/80 backdrop-blur-md border-b border-emerald-500/20 px-4 py-4 lg:px-8 transition-all duration-300">
        <nav className="flex items-center justify-between max-w-7xl mx-auto" aria-label="Menu principal">
          <div className="flex items-center space-x-3">
            <div className="w-8 h-8 bg-gradient-to-br from-emerald-400 to-cyan-400 rounded-lg flex items-center justify-center transition-transform hover:scale-110 shadow-lg shadow-emerald-500/50">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-2 gap-12 items-center">
              <div className="text-center lg:text-left">
                <Badge className="mb-6 bg-emerald-500/20 text-emerald-100 border-emerald-500/50 hover:bg-emerald-500/30 transition-all duration-300 inline-block">
                  <div className="w-4 h-4 rounded-full overflow-hidden inline-block mr-2 -ml-1 border border-emerald-300 bg-white flex-shrink-0">
              ...
              <div className="relative">
                ...
                <div className="relative z-10">
                  <WhatsAppChat />
                  <div className="absolute -top-8 -right-8 w-24 h-24 rounded-full border-4 border-emerald-500 shadow-lg shadow-emerald-500/50 overflow-hidden bg-white">
                    <img src="/lia-avatar.png" alt="Avatar da Lia" className="w-full h-full object-cover" />
                  </div>
                </div>
              </div>
            </div>
